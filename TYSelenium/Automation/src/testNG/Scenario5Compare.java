...
public class Scenario5Compare {
	...
	public void test1() throws InterruptedException {
		...
		List<WebElement> price1 = driver.findElements(By.xpath("//div[@class='grid-view browse-page-var2 g34 row grid-view-result-active']/ul/li/div[1]/div/div/a/img/following::span[4]"));
